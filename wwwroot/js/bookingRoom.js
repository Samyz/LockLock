...
window.onload = function () {
  ...
  modalBlack = document.getElementById('BlackModal');
  modalBlackClose = document.getElementById('modalBlackClose');
  console.log(modal);
  ...
  modalBlackClose.onclick = function () {
...
function toModalCancel(id) {
  //   var id = this.data-toID;
  console.log(id);
  var form = document.getElementById('cancelForm');
  form.setAttribute('action', `/BookingRoom/cancel?transactionID=${id}`);
